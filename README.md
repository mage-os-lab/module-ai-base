...
or on a schedule. Supported by OpenAI, Anthropic, OpenRouter, Ollama and LM Studio; other backends (e.g. Azure, whose listing endpoint is resource-specific) simply
