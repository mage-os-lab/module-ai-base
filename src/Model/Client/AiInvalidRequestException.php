 ...
 * window, a model name it does not recognize, or content its safety filter refused to answer.
 *
 ...
 * `ExceedContextSizeException`, `ModelNotFoundException` and `ContentFilterException`: none of the
 * four are recoverable by waiting, which is what separates them from {@see AiTransientException}
 * and {@see AiRateLimitedException} here.
 */
