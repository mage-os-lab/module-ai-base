...
/**
 * The provider failed in a way that is usually temporary: a 5xx response, an overloaded model, or
 * a stream that ended before it reported completion.
 *
 ...
 * builds this from symfony/ai's `ServerException` and `IncompleteStreamException`.
 */
